...
public class Practice14MaskFilterView extends View {
    ...
    Bitmap bitmap;
    MaskFilter blurMaskFilterNoraml = new BlurMaskFilter(50, BlurMaskFilter.Blur.NORMAL);
    MaskFilter blurMaskFilterSolid = new BlurMaskFilter(50, BlurMaskFilter.Blur.SOLID);
    MaskFilter blurMaskFilterInner = new BlurMaskFilter(50, BlurMaskFilter.Blur.INNER);
    MaskFilter blurMaskFilterOuter = new BlurMaskFilter(50, BlurMaskFilter.Blur.OUTER);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第一个：NORMAL
        paint.setMaskFilter(blurMaskFilterNoraml);
